...
export const metadata: Metadata = {
  ...
  description: "Camisetas tailandesas das melhores seleções do mundo: Brasil, Argentina, França, Portugal e mais. Combo 3 por R$ 119,99. Frete grátis acima de R$ 119,99, 12× sem juros.",
  ...
  openGraph: {
    ...
    description: "Camisetas tailandesas das maiores seleções do mundo. 3 por R$ 119,99. Frete grátis acima de R$ 119,99.",
